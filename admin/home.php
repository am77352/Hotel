                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 حجوزات غرفة جديدة<span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
		...
		<th><a href='roombook.php?rid=".$trow['id']." ' class='btn btn-primary'>Action</a></th>
                      ...
                      <!-- End  Basic Table  --> 
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												غرف محجوزة  <span class="badge"><?php echo $r ; ?></span>
											</button>
                                ...
                                <div class="panel panel-danger">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 متابعون <span class="badge"><?php echo $f ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                            ...
                            <div class="table-responsive">
								...
								<a href="messages.php" class="btn btn-primary">حركة اكثر</a>
                            </div>
                        </div>
                    </div>
                                        </div>
