        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="home.php"><i class="fa fa-dashboard"></i> الحالة</a>
                    </li>
                    <li>
                        <a href="messages.php"><i class="fa fa-desktop"></i> الرسائل الإخبارية</a>
                    </li>
					<li>
                        <a class="active-menu" href="roombook.php"><i class="fa fa-bar-chart-o"></i>حجز غرفة</a>
                    </li>
                    <li>
                        <a href="payment.php"><i class="fa fa-qrcode"></i> الدفع</a>
                    </li>
					<li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            حجز الغرفة<small>	<?php echo  $curdate; ?> </small>
                        </h1>
                    </div>
                        ...
                        <div class="panel-footer">
                            <form method="post">
										<div class="form-group">
														<label>حدد المطابقة</label>
														<select name="conf"class="form-control">
															<option value selected>	</option>
															<option value="Conform">تاكيد</option>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
تفاصيل الغرفة المتاحة 
                       </div>
                        <div class="panel-body">
						<table width="200px">
							
							<tr>
								<td><b>الغرفة العلوية	 </b></td>
